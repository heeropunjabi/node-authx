...
module.exports = function (config = {}) {
  ...
  const userEvents = require('./custom-events').userEvents;
  const routes = require('./routes')(config, AuthX, services, userEvents);

  return { AuthX: AuthX, services: services, routes: routes, customEvents: events };
}
